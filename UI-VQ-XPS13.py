...
def init(data):
    ...
    imageURL = "http://68.media.tumblr.com/" + \
                "d3110bf93d880208eb0773d539e85e72/" + \
                "tumblr_owmt7iVg471vbdodoo1_500.gif"
    data.imageWidth = 40
    data.imageHeight = 30
    data.image = PhotoImageFromLink(imageURL, width = data.imageWidth, 
